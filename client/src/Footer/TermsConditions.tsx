...
2.1.1 You may register on Divine Collections in one of the following ways:

a. Creating an Divine Collections account: by providing the relevant information for the creation of your account on Divine Collections and after filling in the necessary forms and providing the necessary details as may be required by us at the time of your registration. Following this, an account with an exclusive username and password (basis your inputs) will be created by Divine Collections for you.

b. Using a third-party account:you may use the login credentials of the account maintained by you with a Divine Collections-integrated third-party (illustratively, Google or Facebook), in which case you will also be subject to the relevant third-party terms and conditions applicable to such account.

2.1.2 You may register on Divine Collections Luxe on successful mobile OTP (One Time Password) verification and you will be eligible to further access and avail the Services after filling in the necessary forms and after providing the necessary details as may be required by us at the time of your registration. For placing an order, you should login to your account by completing the successful mobile OTP verification.
...
8. COPYRIGHTS IN Divine Collections CONTENT

8.1 The Platforms contain material, including text, graphics and sound, which is protected by copyright and/or other intellectual property rights (“Divine Collections Content”). All copyright and other intellectual property rights in the Divine Collections Content are either owned by us or have been licensed to us by the owner(s) of those rights so that it can use the Divine Collections Content as part of the Platforms. We retain copyright on all Information, including text, graphics and sound and all trademarks displayed on the Platforms are either owned by or licensed to us.

8.2 You may use and display the Divine Collections Content on your personal computer only for your personal use subject to the grant of a limited, revocable, personal, non-exclusive and non-transferable license to you by us when you register on any of the Platforms, only for identifying Products, carrying out purchases of Products and processing returns and refunds in accordance with our Return and Refund Policy and for using and printing copies of the information on the Platforms for your personal use and store the files on your computer for personal use only and not for business purposes.

8.3 You may not: (a) copy (whether by printing off onto paper, storing on disk, downloading or in any other way), distribute (including distributing copies), download, display, perform, reproduce, distribute, modify, edit, alter, enhance, broadcast or tamper within any way or otherwise use any Divine Collections Content contained on the Platforms. These restrictions apply in relation to all or part of the Divine Collections Content available on the Platforms; (b) copy and distribute the Information on any other server, or modify or re-use text or graphics on this system or another system; (c) reproduce any part of the Platforms or sell or distribute the same for commercial gain nor shall it be modified or incorporated in any other work, publication or web site, whether in hard copy or electronic format, including postings to any other web site; (d) remove any copyright, trademark or other intellectual property notices contained in the original material from any material copied or printed off from the Platforms; or (e) link any other material to the Platforms, without our express written consent.

8.4 The license granted to you does not include a license for: (a) resale of Products or commercial use of the Platforms or Divine Collections Content, (b) any collection and use of product listings, description, or prices, (c) any use of the Platforms, the Services and/or of Divine Collections Content other than as contemplated in these Terms of Use, (d) any downloading or copying of login credentials of user, (e) any use of data mining, robots, or similar data gathering and extraction tools to extract (whether once or many times) any parts of the Platforms, and (f) creating and/ or publishing your own database that features parts of the Platforms.

8.5 If you believe that your intellectual property rights have been used in a way that raises concerns of infringement, please write to us at customercare@Divine Collections.com and let us know of your concerns.
...
11.3.3 Use the Services in any way that is unlawful, or harms Divine Collections or any other person or entity, as determined in Divine Collections’s sole discretion;
...
12.1 To the fullest extent permitted by law, in no event shall Divine Collections or any of its directors, officers, employees, agents or content or service providers (collectively, the “Divine Collections Representatives”) be liable to you for any direct, indirect, special, incidental, consequential, exemplary, special, remote or punitive damage, including, but not limited to damages for loss of profits, goodwill, use, data or other intangible losses arising from, or directly or indirectly related to, the use of, or the inability to use, the Platforms or the content, materials and functions related thereto, the Services, provision of information via the Platforms, lost business, even if such Divine Collections Representatives have been advised of the possibility of such damages.

12.2 In no event shall Divine Collections Representatives be liable for:
...
12.3 Divine Collections is neither liable nor responsible for any actions or inactions of the other users of the Platforms or any breach of conditions, representations or warranties by them. Divine Collections is not obligated to mediate or resolve any dispute or disagreement amongst two or more users of the Platforms.

12.4 None of the directors, officials or employees of Divine Collections shall be personally liable for any action in connection with the Platforms or the Services thereto.

13. ACCESS OUTSIDE THE REPUBLIC OF INDIA

Divine Collections makes no representation that the content on the Platforms is appropriate to be used or accessed outside the Republic of India. Your use of or access to the Platforms from outside the Republic of India is at your own risk and you are responsible for compliance with the laws of such jurisdiction.
...
Email Address: grievance.officer@Divine Collections.com
...
Email Address: nodalofficer@Divine Collections.com


PART B – TERMS AND CONDITIONS OF SALE ON Divine Collections LUXE PLATFORM
...
1.1 Listing and display of a Product by us on the Platforms is our invitation to you to make an offer for purchase of such Product. Likewise, the placement of an order on the Platforms by you is your offer to buy the Product(s) from us.
